...
namespace DateDiffMVCTest
{
    ...
    public class HomeTests
    {
       private static Object[] test =
       {
          ...
          new Object[] {112, new Date(2018,2,2), new Tuple<int,int,int>(23,3,0) },
           new Object[] {15679, new Date(1957,3,30), new Tuple<int,int,int>(2,11,42)}
          
       };

        [TestCaseSource("test")]
        [Test]
        public void IndexPost_result(int diff,Date start, Tuple<int,int,int> expected)
        {
